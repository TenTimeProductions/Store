    ...
    <ul>
        ...
        <li class="img no-arrow have-message">
            ...
            <ul class="chat-messages">
                <li class="img"><span><div class="chat-detail"><img src="/img/avatars/avatar3.png"/><div class="chat-bubble">Hi you!</div></div></span>
                </li>
                <li class="img"><span><div class="chat-detail"><img src="/img/avatars/avatar3.png"/><div class="chat-bubble">You there?</div></div></span>
                </li>
                <li class="img"><span><div class="chat-detail"><img src="/img/avatars/avatar3.png"/><div class="chat-bubble">Let me know when you come back</div></div></span>
                </li>
        ...
        <li class="img no-arrow">
                <span>
                    <i class="busy"></i>
                    <img src="/img/avatars/avatar13.png" alt="avatar 13"/>
        ...
        <li class="img no-arrow">
                <span>
                    <i class="offline"></i>
                    <img src="/img/avatars/avatar7.png" alt="avatar 7"/>
        ...
        <li class="img no-arrow">
                <span>
                    <i class="offline"></i>
                    <img src="/img/avatars/avatar8.png" alt="avatar 8"/>
        ...
        <li class="img no-arrow">
                <span>
                        <i class="offline"></i>
                        <img src="/img/avatars/avatar9.png" alt="avatar 9"/>
        ...
        <li class="img no-arrow">
                <span>
                    <i class="offline"></i>
                    <img src="/img/avatars/avatar12.png" alt="avatar 12"/>
        ...
        <li class="img no-arrow">
                <span>
                    <i class="offline"></i>
                    <img src="/img/avatars/avatar11.png" alt="avatar 11"/>
        ...
        <li class="img no-arrow">
                <span>
                    <i class="offline"></i>
                    <img src="/img/avatars/avatar10.png" alt="avatar 10"/>
